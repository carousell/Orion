...
- [github.com/carousell/Orion/utils/hystrixprometheus](./../utils/hystrixprometheus)
...
## <a name="AddConfigPath">func</a> [AddConfigPath](./config.go#L177)
``` go
...
## <a name="ResetConfigPath">func</a> [ResetConfigPath](./config.go#L185)
``` go
func ResetConfigPath()
```
ResetConfigPath resets the configuration paths

## <a name="Config">type</a> [Config](./config.go#L18-L54)
``` go
type Config struct {
...
### <a name="BuildDefaultConfig">func</a> [BuildDefaultConfig](./config.go#L83)
``` go
...
### <a name="DefaultServerImpl.AddInitializers">func</a> (\*DefaultServerImpl) [AddInitializers](./core.go#L455)
``` go
...
### <a name="DefaultServerImpl.GetConfig">func</a> (\*DefaultServerImpl) [GetConfig](./core.go#L466)
``` go
...
### <a name="DefaultServerImpl.RegisterService">func</a> (\*DefaultServerImpl) [RegisterService](./core.go#L411)
``` go
...
### <a name="DefaultServerImpl.Start">func</a> (\*DefaultServerImpl) [Start](./core.go#L323)
``` go
func (d *DefaultServerImpl) Start()
```
Start starts the orion server

### <a name="DefaultServerImpl.Stop">func</a> (\*DefaultServerImpl) [Stop](./core.go#L471)
``` go
func (d *DefaultServerImpl) Stop(timeout time.Duration) error
```
Stop stops the server

### <a name="DefaultServerImpl.Wait">func</a> (\*DefaultServerImpl) [Wait](./core.go#L404)
``` go
...
## <a name="HystrixConfig">type</a> [HystrixConfig](./config.go#L57-L64)
``` go
...
### <a name="BuildDefaultHystrixConfig">func</a> [BuildDefaultHystrixConfig](./config.go#L108)
``` go
...
### <a name="BuildDefaultNewRelicConfig">func</a> [BuildDefaultNewRelicConfig](./config.go#L124)
``` go
...
### <a name="GetDefaultServer">func</a> [GetDefaultServer](./core.go#L485)
``` go
...
### <a name="GetDefaultServerWithConfig">func</a> [GetDefaultServerWithConfig](./core.go#L490)
``` go
...
## <a name="ZipkinConfig">type</a> [ZipkinConfig](./config.go#L67-L70)
``` go
...
### <a name="BuildDefaultZipkinConfig">func</a> [BuildDefaultZipkinConfig](./config.go#L117)
``` go
