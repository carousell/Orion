...
* [func RegisterDecoder(svr Server, serviceName, method string, decoder handlers.Decoder)](#RegisterDecoder)
* [func RegisterEncoder(svr Server, serviceName, method, httpMethod, path string, encoder handlers.Encoder)](#RegisterEncoder)
* [func RegisterEncoders(svr Server, serviceName, method string, httpMethod []string, path string, encoder handlers.Encoder)](#RegisterEncoders)
...
## <a name="Decoder">type</a> [Decoder](./types.go#L72)
``` go
type Decoder = handlers.Decoder
```
Decoder is the funtion type needed for request decoders

## <a name="DefaultServerImpl">type</a> [DefaultServerImpl](./core.go#L46-L59)
``` go
...
### <a name="DefaultServerImpl.AddDecoder">func</a> (\*DefaultServerImpl) [AddDecoder](./core.go#L94)
``` go
...
### <a name="DefaultServerImpl.AddEncoder">func</a> (\*DefaultServerImpl) [AddEncoder](./core.go#L80)
``` go
...
### <a name="DefaultServerImpl.AddInitializers">func</a> (\*DefaultServerImpl) [AddInitializers](./core.go#L325)
``` go
func (d *DefaultServerImpl) AddInitializers(ins ...Initializer)
```
AddInitializers adds the initializers to orion server

### <a name="DefaultServerImpl.Fetch">func</a> (\*DefaultServerImpl) [Fetch](./core.go#L74)
``` go
func (d *DefaultServerImpl) Fetch(key string) (value interface{}, found bool)
```
Fetch fetches values for use by initializers

### <a name="DefaultServerImpl.GetConfig">func</a> (\*DefaultServerImpl) [GetConfig](./core.go#L336)
``` go
func (d *DefaultServerImpl) GetConfig() map[string]interface{}
```
GetConfig returns current config as parsed from the file/defaults

### <a name="DefaultServerImpl.GetOrionConfig">func</a> (\*DefaultServerImpl) [GetOrionConfig](./core.go#L107)
``` go
...
### <a name="DefaultServerImpl.RegisterService">func</a> (\*DefaultServerImpl) [RegisterService](./core.go#L290)
``` go
...
### <a name="DefaultServerImpl.Start">func</a> (\*DefaultServerImpl) [Start](./core.go#L241)
``` go
func (d *DefaultServerImpl) Start()
```
Start starts the orion server

### <a name="DefaultServerImpl.Stop">func</a> (\*DefaultServerImpl) [Stop](./core.go#L341)
``` go
func (d *DefaultServerImpl) Stop(timeout time.Duration) error
```
Stop stops the server

### <a name="DefaultServerImpl.Store">func</a> (\*DefaultServerImpl) [Store](./core.go#L62)
``` go
func (d *DefaultServerImpl) Store(key string, value interface{})
```
Store stores values for use by initializers

### <a name="DefaultServerImpl.Wait">func</a> (\*DefaultServerImpl) [Wait](./core.go#L283)
``` go
...
### <a name="HTTPZipkinInitializer">func</a> [HTTPZipkinInitializer](./initializer.go#L66)
``` go
...
### <a name="GetDefaultServer">func</a> [GetDefaultServer](./core.go#L355)
``` go
...
### <a name="GetDefaultServerWithConfig">func</a> [GetDefaultServerWithConfig](./core.go#L360)
``` go
