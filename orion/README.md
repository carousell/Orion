...
### How do i use it
Lets go throught the example defined at <a href="https://github.com/carousell/Orion/tree/master/example/simple">https://github.com/carousell/Orion/tree/master/example/simple</a> , It covers the minimum required implementation for orion. It has the following structure
...
## <a name="RegisterDecoder">func</a> [RegisterDecoder](./utils.go#L25)
``` go
...
## <a name="RegisterHandler">func</a> [RegisterHandler](./utils.go#L31)
``` go
...
## <a name="Decoder">type</a> [Decoder](./types.go#L69)
``` go
type Decoder = handlers.Decoder
```
Decoder is the funtion type needed for request decoders

## <a name="DefaultServerImpl">type</a> [DefaultServerImpl](./core.go#L47-L60)
``` go
...
### <a name="DefaultServerImpl.AddDecoder">func</a> (\*DefaultServerImpl) [AddDecoder](./core.go#L98)
``` go
...
### <a name="DefaultServerImpl.AddEncoder">func</a> (\*DefaultServerImpl) [AddEncoder](./core.go#L63)
``` go
...
### <a name="DefaultServerImpl.AddHTTPHandler">func</a> (\*DefaultServerImpl) [AddHTTPHandler](./core.go#L81)
``` go
...
### <a name="DefaultServerImpl.AddInitializers">func</a> (\*DefaultServerImpl) [AddInitializers](./core.go#L334)
``` go
func (d *DefaultServerImpl) AddInitializers(ins ...Initializer)
```
AddInitializers adds the initializers to orion server

### <a name="DefaultServerImpl.GetConfig">func</a> (\*DefaultServerImpl) [GetConfig](./core.go#L345)
``` go
func (d *DefaultServerImpl) GetConfig() map[string]interface{}
```
GetConfig returns current config as parsed from the file/defaults

### <a name="DefaultServerImpl.GetOrionConfig">func</a> (\*DefaultServerImpl) [GetOrionConfig](./core.go#L111)
``` go
...
### <a name="DefaultServerImpl.RegisterService">func</a> (\*DefaultServerImpl) [RegisterService](./core.go#L299)
``` go
...
### <a name="DefaultServerImpl.Start">func</a> (\*DefaultServerImpl) [Start](./core.go#L245)
``` go
func (d *DefaultServerImpl) Start()
```
Start starts the orion server

### <a name="DefaultServerImpl.Stop">func</a> (\*DefaultServerImpl) [Stop](./core.go#L350)
``` go
func (d *DefaultServerImpl) Stop(timeout time.Duration) error
```
Stop stops the server

### <a name="DefaultServerImpl.Wait">func</a> (\*DefaultServerImpl) [Wait](./core.go#L292)
``` go
func (d *DefaultServerImpl) Wait() error
```
Wait waits for all the serving servers to quit

## <a name="Encoder">type</a> [Encoder](./types.go#L66)
``` go
type Encoder = handlers.Encoder
```
Encoder is the function type needed for request encoders

## <a name="HTTPHandler">type</a> [HTTPHandler](./types.go#L72)
``` go
...
## <a name="Initializer">type</a> [Initializer](./types.go#L42-L45)
``` go
...
### <a name="HTTPZipkinInitializer">func</a> [HTTPZipkinInitializer](./initializer.go#L61)
``` go
...
## <a name="PostInitializer">type</a> [PostInitializer](./types.go#L61-L63)
``` go
...
## <a name="PreInitializer">type</a> [PreInitializer](./types.go#L56-L58)
``` go
...
## <a name="Server">type</a> [Server](./types.go#L24-L39)
``` go
...
### <a name="GetDefaultServer">func</a> [GetDefaultServer](./core.go#L364)
``` go
...
### <a name="GetDefaultServerWithConfig">func</a> [GetDefaultServerWithConfig](./core.go#L369)
``` go
...
## <a name="ServiceFactory">type</a> [ServiceFactory](./types.go#L48-L53)
``` go
