...
func (c *echoServiceClient) ABC(ctx context.Context, in *UpperRequest, opts ...grpc.CallOption) (*UpperResponse, error) {
	out := new(UpperResponse)
	err := grpc.Invoke(ctx, "/echo_proto.EchoService/ABC", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _EchoService_ABC_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(UpperRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(EchoServiceServer).ABC(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/echo_proto.EchoService/ABC",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(EchoServiceServer).ABC(ctx, req.(*UpperRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _EchoService_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "ABC",
			Handler:    _EchoService_ABC_Handler,
		},
	},
...
var fileDescriptor0 = []byte{
	...
	0x28, 0x72, 0xf1, 0x42, 0x55, 0xe0, 0x32, 0xc4, 0xe8, 0x04, 0x23, 0xc4, 0x21, 0xc1, 0xa9, 0x45,
	0x65, 0x99, 0xc9, 0xa9, 0x42, 0xd6, 0x5c, 0x2c, 0x20, 0xae, 0x90, 0xb8, 0x1e, 0xc2, 0xb1, 0x7a,
	0x48, 0x2e, 0x95, 0x92, 0xc0, 0x94, 0x80, 0x18, 0xae, 0xc4, 0x20, 0x64, 0xc7, 0xc5, 0x5a, 0x0a,
	0xb2, 0x4f, 0x08, 0x45, 0x11, 0xb2, 0x23, 0xa5, 0x24, 0xb1, 0xc8, 0xc0, 0xf5, 0xdb, 0x70, 0x31,
	0x3b, 0x3a, 0x39, 0x93, 0xa9, 0x3b, 0x89, 0x0d, 0x2c, 0x6c, 0x0c, 0x08, 0x00, 0x00, 0xff, 0xff,
	0x6c, 0x0a, 0xcd, 0xc1, 0x73, 0x01, 0x00, 0x00,
}
